...
var Erase = function () {
  ...
  this.canvasHeight = 1508
  this.radius = 10
  this.scale = 1
  this.speed = 15
  this.touchTime = 0
}
Erase.prototype.init = function (el, canvasWidth, canvasHeight, imgUrl, radius, scale) {
  this.radius = radius
  this.canvasBox = el
  this.scale = scale
...
Erase.prototype.createElement = function (w=300, h=150) {
...
Erase.prototype.createCanvas = function (canvasWidth, canvasHeight, imgUrl) {
...
Erase.prototype.afterImageLoad = function(img) {
...
Erase.prototype.getDeviceType = function() {
...
Erase.prototype.clear = function(context,width = 0,height = 0) {
  var centerX = width/2;
...
Erase.prototype.canvasEventInit = function() {
